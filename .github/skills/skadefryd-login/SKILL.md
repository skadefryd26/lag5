...
It may open the browser by itself. Do not rely on that. Read the code from the output and send
the participant this, with **their** code in it:

> Nå må du logge inn på GitHub, så jeg kan lagre arbeidet ditt der. Det tar et minutt, og du
> trenger ikke skrive noe annet enn denne koden.
>
> 1. Åpne denne lenka i nettleseren: https://github.com/login/device
> 2. Logg inn på GitHub hvis den spør.
> 3. Skriv inn koden **ABCD-1234** og trykk **Continue**.
> 4. Trykk den grønne knappen **Authorize github**.
> 5. Når det står at du er ferdig, kan du lukke fanen og si «ferdig» her.

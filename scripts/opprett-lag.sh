...
1. Hent prosjektet ned til mappa skadefryd/lag$n i hjemmemappa mi, hvis det ikke ligger der allerede. Mangler maskinen det som trengs for å hente det, står det hvordan du ordner det i .github/skills/skadefryd-machine-setup/SKILL.md i prosjektet på GitHub.
